...
Vector helper procedures let you configure authentication credentials, preferences, and language-specific data for use in chainable utility functions.<br>At a high level, the supplied vector helper procedures include:
