...
[ UTL_TO_TEXT ](utl_to_text.html#GUID-73397E89-92FB-48ED-94BB-1AD960C4EA1F) |  Extracts plain text data from documents   
[ UTL_TO_CHUNKS ](utl_to_chunks-dbms_vector_chain.html#GUID-4E145629-7098-4C7C-804F-FC85D1F24240) |  Splits data into smaller pieces or chunks   
[ UTL_TO_EMBEDDING and UTL_TO_EMBEDDINGS ](utl_to_embedding-and-utl_to_embeddings-dbms_vector_chain.html#GUID-C6439E94-4E86-4ECD-954E-4B73D53579DE) |  Converts text or an image to one or more vector embeddings   
[ UTL_TO_SUMMARY ](utl_to_summary.html#GUID-EC9DDB58-6A15-4B36-BA66-ECBA20D2CE57) |  Extracts a summary from documents   
[ UTL_TO_GENERATE_TEXT ](utl_to_generate_text-dbms_vector_chain.html#GUID-017C9002-194C-48E5-B59B-EF5C60BC8405) |  Generates text for a prompt (input string) or an image   
...
[ CREATE_CREDENTIAL ](create_credential-dbms_vector_chain.html#GUID-A6E28402-DC43-44C6-A1B2-75C3F270DD76) |  Creates a credential name   
[ DROP_CREDENTIAL ](drop_credential-dbms_vector_chain.html#GUID-FCA739BA-4849-45BF-A860-251D45E31B17) |  Drops an existing credential name   
...
[ CREATE_PREFERENCE ](create_preference.html#GUID-B83978CD-EAF8-4794-9652-F335C54C3385) |  Creates a vectorizer preference   
[ DROP_PREFERENCE ](drop_preference.html#GUID-72CCB0E1-2FB9-4F94-A3A5-6090E1927D3A) |  Drops an existing vectorizer preference   
...
[ CREATE_VOCABULARY ](create_vocabulary.html#GUID-2D19528E-0F0D-4102-8EC7-E9EA62C66C2D) |  Loads your token vocabulary file into the database   
[ DROP_VOCABULARY ](drop_vocabulary.html#GUID-2CC9EBDB-717F-4AA7-8FDE-7503BE185D87) |  Removes existing vocabulary data   
[ CREATE_LANG_DATA ](create_lang_data.html#GUID-C9756FA9-B0B6-4750-8D9C-ADEF8B67C675) |  Loads your language data file into the database   
[ DROP_LANG_DATA ](drop_lang_data.html#GUID-55F54E07-1026-4021-A194-3E068471426E) |  Removes existing abbreviation data   
Data Access Function  :  This function enables you to enhance search operations.   
[ RERANK ](rerank-dbms_vector_chain.html#GUID-08B0E5EE-B097-43CD-828C-05D45B70157D) |  Reorders search results for a more relevant output   
