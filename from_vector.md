...
![Description of from_vector.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img/from_vector.gif)[ Description of the illustration from_vector.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img_text/from_vector.md)
