...
<br>![Description of cosine_similarity_2x2.png follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img/cosine_similarity_2x2.png)<br>[Descriptionof the illustration cosine_similarity_2x2.png](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img_text/cosine_similarity_2x2.md)<br>**Parent topic:** [Vector Distance Metrics](vector-distance-metrics.md)