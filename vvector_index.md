...
` INDEX_ORGANIZATION ` |  ` VARCHAR(129) ` |  The vector index organization. The value can be one of the following: <ul>

<li>
  * ` NEIGHBOR PARTITIONS ` </li> <li>
  * ` INMEMORY NEIGHBOR GRAPH ` </li> </ul>  
...
` DISTANCE_TYPE ` |  ` VARCHAR2(129) ` |  Possible distance values: <ul> <li>
    * ` EUCLIDEAN ` </li> <li>
...
` INDEX_DIM_TYPE ` |  ` VARCHAR2(129) ` |  Type of the dimensions of the index vector.  Possible values: <ul> <li>
      * ` FLOAT16 ` </li> <li>
      * ` FLOAT32 ` </li> <li>
      * ` FLOAT64 ` </li> <li>
      * ` INT8 ` </li> </ul>  
