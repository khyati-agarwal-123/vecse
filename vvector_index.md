...
* `NEIGHBOR PARTITIONS`<br>`INMEMORY NEIGHBOR GRAPH`
...
* `EUCLIDEAN`<br>`EUCLIDEAN_SQUARED`<br>`COSINE`<br>`DOT`<br>`MANHATTAN`<br>`HAMMING`
...
* `FLOAT16`<br>`FLOAT32`<br>`FLOAT64`<br>`INT8`
