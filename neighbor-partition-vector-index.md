...
* [About Neighbor Partition Vector Index](neighbor-partition-vector-indexes.md)<br>The default type of index created for a Neighbor Partition vector index is Inverted File Flat. 
* [Inverted File Flat Index Syntax and Parameters](inverted-file-flat-index-syntax-and-parameters.md)<br>Review the syntax and examples for Inverted File Flat vector indexes. 
