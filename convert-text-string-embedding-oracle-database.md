...
1. Load your ONNX format embedding model into Oracle Database.<br>For detailed information on how to perform this step, see [Import ONNX Models into Oracle Database End-to-End Example](import-onnx-models-oracle-database-end-end-example.md#GUID-6AEA7A0E-78E0-4083-A126-4516EB98175A). 
