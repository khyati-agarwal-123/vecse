...
The name of the model follows the same restrictions as those used for other machine learning models, namely: 
  ...
  * The model must not depend on external initializers. To know more about initializers and other ONNX concepts, see [ https://onnx.ai/onnx/intro/concepts.md ](https://onnx.ai/onnx/intro/concepts.md) . 
