...
This example uses ` * ` to allow any host. However, you can explicitly specify the host that you want to connect to. 
    ...
    6. Set up your credentials for the REST provider that you want to access and then call ` UTL_TO_GENERATE_TEXT ` : 
...
> **note:** If you want to pass any additional REST provider-specific parameters, then you must enclose those in ` chatRequest ` . 
         ...
         3. Using Cohere, Google AI, Hugging Face, OpenAI, and Vertex AI  : 
...
**Parent topic:** [ Generate Text Response ](generate-text-response.html)