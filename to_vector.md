...
![Description of to_vector_vecse.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img/to_vector_vecse.gif)[ Description of the illustration to_vector_vecse.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img_text/to_vector_vecse.md)
