...
INDEX_USER<br>Specify the user name of the HNSW vector index owner.

INDEX_NAME<br>Specify the name of the HNSW vector index for which you want to disable the Checkpoint feature.<br>The `INDEX_NAME` clause is optional. If you do not specify the index name, then this procedure disables the Checkpoint feature for all HNSW vector indexes under the given user. 
