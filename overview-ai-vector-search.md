...
![Description of vector_embeddings.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img/vector_embeddings.png)[ Description of the illustration vector_embeddings.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img_text/vector_embeddings.md)
...
![Description of vector_embeddings_similarity.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img/vector_embeddings_similarity.png)[ Description of the illustration vector_embeddings_similarity.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img_text/vector_embeddings_similarity.md)
...
![Description of vector_embeddings_similarity_search.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img/vector_embeddings_similarity_search.png)[ Description of the illustration vector_embeddings_similarity_search.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img_text/vector_embeddings_similarity_search.md)
...
![Description of Figure 2-1 follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img/basic_transform.png)[ Description of "Figure 2-1 Vector Embedding Model" ](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img_text/basic_transform.md)
