...
<br>![Description of Figure 6-1 follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img/vector_pool.png)<br>[Descriptionof "Figure 6-1 Vector Pool"](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img_text/vector_pool.md)

<br>To size the Vector Pool in an on-premises environment, use the VECTOR_MEMORY_SIZE initialization parameter. You can dynamically modify this parameter at the following levels: 
