...
![Description of Figure 6-1 follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img/vector_pool.png)[ Description of "Figure 6-1 Vector Pool" ](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img_text/vector_pool.md)
...
> **note:** See Also: 
      * [ Vector Memory Pool Views ](vector-memory-pool-views.html#GUID-4A5CCD79-4E1E-4E53-93AD-C940C3DFD687)
