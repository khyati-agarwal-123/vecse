## Vector Serializers {#GUID-0876CB8B-8749-4A40-9B20-A27CE7415241}
...
* [FROM_VECTOR](from_vector.md)<br>`FROM_VECTOR` takes a vector as input and returns a string of type `VARCHAR2` or `CLOB` as output. 
* [VECTOR_SERIALIZE](vector_serialize.md)<br>`VECTOR_SERIALIZE` is synonymous with `FROM_VECTOR.`
