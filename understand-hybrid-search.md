...
With hybrid search, you can search through your documents by performing a combination of full-text queries and vector-based similarity queries, using out-of-the-box or custom scoring techniques.<br>Here are the key points to note when using hybrid search:
...
![Description of Figure 8-2 follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img/keyword_semantic_document_mode_query.png)<br>[Descriptionof "Figure 8-2 Scoring for Keyword and Semantic Search in Document Mode"](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img_text/keyword_semantic_document_mode_query.md)
...
![Description of Figure 8-5 follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img/fuse_operators_chunk_mode.png)<br>[Descriptionof "Figure 8-5 Fusion Operation in Chunk Search Mode"](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img_text/fuse_operators_chunk_mode.md)
