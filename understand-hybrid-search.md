...
Here are the key points to note when using hybrid search: 
  ...
  * Hybrid searches are run against hybrid vector indexes (as explained in [ Manage Hybrid Vector Indexes ](manage-hybrid-vector-indexes.html#GUID-F2493927-23F8-4231-862B-6EDFA5A12299) ). You use the ` DBMS_HYBRID_VECTOR.SEARCH ` PL/SQL function to query a hybrid vector index. 
  ...
  * After you create a hybrid vector index, you have five possibilities to use the index by querying it in multiple **search modes** summarized here: 
    ...
    * [ Pure Semantic in Document Mode ](understand-hybrid-search.html#GUID-310D2298-90F4-4AFE-AF03-F3B81E55F84C__GUID-CA1E17B9-796C-4F54-B15B-71E9E9F5F9C2)

    * [ Pure Semantic in Chunk Mode ](understand-hybrid-search.html#GUID-310D2298-90F4-4AFE-AF03-F3B81E55F84C__GUID-0611B161-9E85-449A-8574-0ECD1D156C60)

    * [ Pure Keyword in Document Mode ](understand-hybrid-search.html#GUID-310D2298-90F4-4AFE-AF03-F3B81E55F84C__GUID-03905981-A6E9-4D2C-A0DC-0807A95AA3F3)

    * [ Keyword and Semantic in Document Mode ](understand-hybrid-search.html#GUID-310D2298-90F4-4AFE-AF03-F3B81E55F84C__GUID-7C48C489-FCB6-4838-918F-BA6C847032F4)
...
For the sake of the following explanations, we are using the same use case as seen in [ Understand Hybrid Vector Indexes ](understand-hybrid-vector-indexes.html#GUID-28C18166-43BB-4D2C-B8B3-8127D3485578) : 

![Description of overview_hybrid_vector_index.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img/overview_hybrid_vector_index.png)[ Description of the illustration overview_hybrid_vector_index.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img_text/overview_hybrid_vector_index.md)
...
![Description of pure_semantic_document_mode_query.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img/pure_semantic_document_mode_query.png)[ Description of the illustration pure_semantic_document_mode_query.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img_text/pure_semantic_document_mode_query.md)
...
![Description of Figure 8-2 follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img/keyword_semantic_document_mode_query.png)[ Description of "Figure 8-2 Scoring for Keyword and Semantic Search in Document Mode" ](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img_text/keyword_semantic_document_mode_query.md)
...
![Description of Figure 8-3 follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img/fuse_operators_doc_mode.png)[ Description of "Figure 8-3 Fusion Operation in Document Search Mode" ](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img_text/fuse_operators_doc_mode.md)
...
![Description of Figure 8-5 follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img/fuse_operators_chunk_mode.png)[ Description of "Figure 8-5 Fusion Operation in Chunk Search Mode" ](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img_text/fuse_operators_chunk_mode.md)

**Related Topics**

                     * [ Understand Hybrid Vector Indexes ](understand-hybrid-vector-indexes.html#GUID-28C18166-43BB-4D2C-B8B3-8127D3485578)
                     * [ SEARCH ](search.html#GUID-A386BDB0-35D0-41E1-8F41-49AEBEC13BFC)

**Parent topic:** [ Perform Hybrid Search ](perform-hybrid-search.html)