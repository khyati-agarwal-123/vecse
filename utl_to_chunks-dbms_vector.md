## UTL_TO_CHUNKS {#GUID-4D96238E-2ABD-450D-8A9A-65E16A33481A}
...
DATA<br>This function accepts the input data type as `CLOB` or `VARCHAR2`. <br>It returns an array of `CLOB`s, where each `CLOB` contains a chunk along with its metadata in JSON format, as follows: 
```
{
"chunk_id"     : NUMBER,
"chunk_offset" : NUMBER,
