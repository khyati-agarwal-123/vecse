...
![Description of jaccard_similarity.png follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img/jaccard_similarity.png)[ Description of the illustration jaccard_similarity.png ](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img_text/jaccard_similarity.md)**Parent topic:** [ Vector Distance Metrics ](vector-distance-metrics.html)