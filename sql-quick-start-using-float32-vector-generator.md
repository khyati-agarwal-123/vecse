...
<br>![Description of Figure 3-1 follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img/vector_clusters.png)<br>[Descriptionof "Figure 3-1 Vector Clusters"](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img_text/vector_clusters.md)

<br>5. Run a similarity search on the generated vectors in the `genvec` table.
