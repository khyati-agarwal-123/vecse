...
---|---|---  
TABLE ACCESS  |  FULL  |  ` VECTOR$  $< id  >$IVF_FLAT_CENTROIDS ` ` VECTOR$DOCS_IVF_IDX2$< id  >$IVF_FLAT_CENTROID_PARTITIONS `  
...
TABLE ACCESS  |  INMEMORY FULL  |  ` VECTOR$  $< id  >$IVF_FLAT_CENTROIDS ` ` VECTOR$DOCS_IVF_IDX2$< id  >$IVF_FLAT_CENTROID_PARTITIONS `  
