...
---|---|---  
`function` | String |  Specify regression, classification, clustering, or embedding. This is a mandatory setting. <br>**NOTE**: The only JSON parameter required when importing the model is the machine learning function.   
