...
HNSW Index Creation and Repopulation<br>The following diagram summarizes what happens when you create the HNSW index in an Oracle RAC environment:
...
![Description of hnsw_initial_population.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img/hnsw_initial_population.png)<br>[Descriptionof the illustration hnsw_initial_population.eps](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img_text/hnsw_initial_population.md)
