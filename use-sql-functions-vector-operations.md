...
> **note:** You can also use PL/SQL packages to perform similar operations and additional tasks. See [ Vector Search PL/SQL Packages ](vector-search-pl-sql-packages-node.html#GUID-04ACF179-957C-4F03-AC1D-4DA44B3E12A2) . 
