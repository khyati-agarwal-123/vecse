...
![Description of Figure 9-1 follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img/chatbot_llm_workflow.png)[ Description of "Figure 9-1 Example RAG Workflow" ](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img_text/chatbot_llm_workflow.md)
