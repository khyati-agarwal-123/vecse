...
This example uses ` * ` to allow any host. However, you can explicitly specify the host that you want to connect to. 
    ...
    6. Set up your credentials for the REST provider that you want to access and then call ` UTL_TO_SUMMARY ` . 
...
**Parent topic:** [ Generate Summary ](generate-summary.html)