...
![Description of global_ivf_index.eps follows](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img/global_ivf_index.png)[ Description of the illustration global_ivf_index.eps ](https://docs.oracle.com/en/database/oracle/oracle-database/23/vecse/img_text/global_ivf_index.md)
