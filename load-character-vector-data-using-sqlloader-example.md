...
In this example, you can see how to use SQL*Loader to load vector data into a five-dimension vector space.<br>Let's imagine we have the following text documents classifying galaxies by their types:
