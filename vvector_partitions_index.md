...
` INDEX_PARTITIONS_TYPE ` |  ` VARCHAR2(129) ` |  The partition type of this neighbor partitions vector index.  Possible values include: <ul>

<li>
  * ` IVF ` : Inverted File Index </li> </ul>  
